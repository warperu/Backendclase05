...
// Definición de la interfaz LigaJusticia
interface LigaJusticia {
    nombre: string;
    artesMarciales: string[];
}

// Implementación del objeto batman que cumple con la interfaz LigaJusticia
const batman: LigaJusticia = {
    nombre: "BrSuce Wayne",
    artesMarciales: ["Karate", "Jiu-Jitsu", "Taekwondo", "Kung Fu"]
};

// Mostrar el objeto batman en la consola
console.log(batman);